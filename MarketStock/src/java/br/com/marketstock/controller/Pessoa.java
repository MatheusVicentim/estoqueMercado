    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sessao != null) {
            try {
                ...
                request.setAttribute("lEstados", oEstadoDAO.listar());
                request.getRequestDispatcher("/backEnd/pessoaControle/pessoaCadastrarControle.jsp").forward(request, response);
            } catch (Exception ex) {
