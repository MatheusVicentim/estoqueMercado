 ...
 * @author mathe
 */
@WebServlet(name = "EmbalagemListar", urlPatterns = {"/EmbalagemListar"})
public class EmbalagemListar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sessao != null) {
            try {
                ...
                request.setAttribute("lEmabalagens", oEmbalagemDAO.listar());
                //request.getRequestDispatcher("funcionario.jsp").forward(request, response);
                request.getRequestDispatcher("/backEnd/viewAltera/embalagemView.jsp").forward(request, response);
            } catch (Exception ex) {
