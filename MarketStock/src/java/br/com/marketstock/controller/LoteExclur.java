 ...
 * @author mathe
 */
@WebServlet(name = "LoteExclur", urlPatterns = {"/LoteExclur"})
public class LoteExclur extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sessao != null) {
            ...
            try {
                ...
                Lote oLote = (Lote) oLoteDAO.carregaInativaAtiva(nIdLote);
                //Usado para abrir conexão com BD
                oLoteDAO = new LoteDAO();
                if (oLoteDAO.excluir(oLote)) {
                    sMensagem = "Lote " + oLote.getSituacao() + " com sucesso!";
                } else {
                ...
                request.getRequestDispatcher("LoteListar").forward(request, response);
            } catch (Exception ex) {
