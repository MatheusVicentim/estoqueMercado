 ...
 */
@WebServlet(name = "UnidadeMedida", urlPatterns = {"/UnidadeMedida"})
public class UnidadeMedida extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sessao != null) {
            try {
                request.getRequestDispatcher("/backEnd/unidadeMedidaControle.jsp").forward(request, response);
            } catch (Exception ex) {
