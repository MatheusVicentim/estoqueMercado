    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sessao != null) {
            ...
            try {
                ...
                UnidadeMedida oMedida = (UnidadeMedida) oMedidaDAO.carregaInativaAtiva(nIdMedida);
                //Usado para abrir conexão com BD
                oMedidaDAO = new UnidadeMedidaDAO();
                if (oMedidaDAO.excluir(oMedida)) {
                    sMensagem = "Unidade de Medida " + oMedida.getSituacao() + " com sucesso!";
                } else {
                    sMensagem = "Problemas ao ativar ou excluir Unidade Medida!";
                }
                request.setAttribute("mensagem", sMensagem);
                request.getRequestDispatcher("UnidadeMedidaListar").forward(request, response);
            } catch (Exception ex) {
