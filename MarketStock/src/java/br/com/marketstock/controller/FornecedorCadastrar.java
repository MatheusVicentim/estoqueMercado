    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sessao != null) {
            ...
            try {
                ...
                if (oFornecedor.getSenha().length() >= 4 && sConfirmaSenha.length() >= 4 && oFornecedor.getSenha().equals("sConfirmaSenha")) {
                    ...
                    if (oFornecedorDAO.cadastrar(oFornecedor)) {
                        gsMensagem = "Informações do Fornecedor foram cadastradas com Sucesso! (Servlet)";
                    } else {
                        gsMensagem = "Problemas ao cadastrar informações do Fornecedor. Verifique os dados e tente novamente! (Servlet)";
                    }
                } else {
                    request.setAttribute("msg", "<div class='msg alert alert-warning'>Erro ao cadastrar Fornecedor, senha diferente da confirmação. Verifique os dados e tente novamente!</div>");
