 ...
 * @author rafae
 */
@WebServlet(name = "Embalagem", urlPatterns = {"/Embalagem"})
public class Embalagem extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sessao != null) {
            try {
                request.getRequestDispatcher("/backEnd/embalagemControle.jsp").forward(request, response);
            } catch (Exception ex) {
