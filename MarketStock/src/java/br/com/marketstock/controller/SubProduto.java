 ...
 */
@WebServlet(name = "SubProduto", urlPatterns = {"/SubProduto"})
public class SubProduto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sessao != null) {
            try {
                request.getRequestDispatcher("/backEnd/subProdutoControle.jsp").forward(request, response);
            } catch (Exception ex) {
