    ...
    <c:when test = "${sessionScope.idPessoa != null}">
        ...
        <html lang="en">
            ...
            <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60" onload="myFunction()">
                                    ...
                                    <div class="collapse navbar-collapse" id="lauraMenu">
                                        <ul class="nav navbar-nav navbar-right navbar-border">
                                            ...
                                            <li><a href="#" data-toggle="modal" data-target="#logar-modal">Logar</a></li>
                                                ...
                                                %>
                                            <li class="nav-item">
                                            <li><a href="${pageContext.request.contextPath}/Notificacao">Painel Controle</a></li>
                                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="" onclick="deslogar()" name="sair" id="sair" style="margin-top: 2.5%">
                ...
                <!-- Large modal -->
                <div class="modal fade bs-example-modal-lg" id="logar-modal" tabindex="-1" role="dialog" aria-labelledby="cadastrarGenero" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form  data-toggle="validator" name="frmLogarUsuario" id="frmLogarUsuario" method="POST">
                                <div class="modal-body">                                     
                                    <!--<div class="form-group row">
                                       <label class="col-sm-12 col-md-2 col-form-label" >ID:</label>
                                       <div class="col-sm-12 col-md-10">
                                          <input class="form-control fct" readonly="readonly" type="text" id="idGenero" name="idGenero"/>
                                       </div>
                                    </div>-->
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-10">
                                            <input class="form-control fct" type="text" name="senha" id="descricao" data-error="Por favor, preencha o campo de senha!" required/>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="wrap-select100 validate-select">
                                        <select class="select100" name="tipoPessoa" id="tipoPessoa">
                                            <option value="G">Funcionário</option>
                                            <option value="C">Gerente</option>
                                            <option value="V">Fornecedor</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="modal-footer"> 
                                    ...
                                    <p id="errorlog" align="center">Usuário ou senha incorretos</p>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <script>
                                                $(document).ready(function () {
                                                    $('#errorlog').hide();
                                                    $('#frmLogarUsuario').submit(function () {
                                                        var login = $('#login').val();
                                                        var senha = $('#senha').val();
                                                        var tipoPesoa = $('#senha').val();
                                                        $.ajax({
                                                            url: "/MarketStock/PessoaLogar",
                                                            type: "post",
                                                            data: "login=" + login + "&senha=" + senha + "&tipoPessoa=" + tipoPesoa,
                                                            success: function (result) {
                                                                if (result === "ok") {
                                                                    location.href = 'indexLogado.jsp';
                                                                } else {
                                                                    $('#errorlog').show();
                                                                }
                                                            }
                ...
                <!--Script para finalizar login Verificar se esta certo-->
                <script>
                    function deslogar() {
